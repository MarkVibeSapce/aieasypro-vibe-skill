...
0. **เช็ค `docs/discovery.md` ก่อน** — ถ้ามี (มาจาก `/design-thinking`) ให้อ่านก่อนถาม.
   discovery.md ตอบไปแล้ว: โปรดักต์ / ปัญหา / user หลัก / insight จากลูกค้าจริง.
   → **อย่าถามซ้ำสิ่งที่ตอบแล้ว** — สรุปให้ user ยืนยัน แล้วถามเฉพาะที่ยังขาด (features/roles/data).
   ถ้าไม่มี discovery.md → ทำข้อ 1 ตามปกติ.

1. **ถามให้ครบก่อนเขียน** — ห้ามเดา. ถามทีละกลุ่ม สั้นๆ (ข้ามข้อที่ discovery.md ตอบแล้ว):
